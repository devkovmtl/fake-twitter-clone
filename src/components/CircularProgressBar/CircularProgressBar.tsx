...
const CircularProgressBar = ({
  ...
  return (
    <div
      className={`circular-progress relative bg-white dark:bg-black rounded-full grid place-items-center before:content-[""] before:absolute before:h-5/6 before:w-5/6  before:bg-[rgb(255,255,255)] before:dark:[rgb(0,0,0)] before:rounded-full p-1`}
      style={{
        height: `${width}px`,
        width: `${width}px`,
        background:
